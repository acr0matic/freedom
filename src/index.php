                        ...
                        <div class="swiper-slide">
                          <div class="about-map__item about-map__item--1">
                            ...
                            <div class="about-map__content">
                              <img data-tippy-content="Пешеходный мост – зона променада с новыми видовыми точками" src="img/icons/control/tooltip.svg" alt="" class="about-map__tooltip">
                              <img data-tippy-content="Подвесные качели для отдыха и неформального общения" src="img/icons/control/tooltip.svg" alt="" class="about-map__tooltip">
                              <img data-tippy-content="Сухой фонтан станет центром притяжения горожан" src="img/icons/control/tooltip.svg" alt="" class="about-map__tooltip">
